...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
Write a function named countNumberOfElements that, given an array as input, uses reduce to number the number of elements in the array.
Note: You may not use the array's built-in length property.
------------------------------------------------------------------------------------------------ */

const countNumberOfElements = (arr) => {
  let number = arr.reduce((accumulator) => {
    accumulator += 1;
    return (accumulator);
  }, 0);
  return(number);
...
const returnNames = (arr) => {
  let arrOfName = arr.reduce((accumulator, value) => {
...
const reversedString = (str) => {
  ...
  let reverOrder = arrOfString.reduce((accumulator, value) => {
    accumulator.unshift(value);
    return (accumulator);
  }, []);
  return(reverOrder.join(''));
};
...
Hint: The accumulator should begin as { number: 0, sum: 0 }
------------------------------------------------------------------------------------------------ */
...
Write a function named countPrimeNumbers that, given an array elements as input, uses reduce to number the number of elements that are prime numbers.
...
xdescribe('Testing challenge 7', () => {
  test('It should return a number of the prime numbers in the array', () => {
